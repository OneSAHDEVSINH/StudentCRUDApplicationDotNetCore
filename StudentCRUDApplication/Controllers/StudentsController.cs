...
namespace StudentCRUDApplication.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Age")] Student student, IFormFile profilePicture)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Age")] Student student, IFormFile profilePicture)
        {
            if (id != student.ID)
            {
                return NotFound();
